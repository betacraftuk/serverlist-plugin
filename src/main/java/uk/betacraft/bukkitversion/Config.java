...
public class Config {
    ...
    private BukkitVersion bukkitversion = BCPing.bukkitversion;
    private File file;
    ...
    public long getLong(String path, long def) {
        if (this.useNew) {
            ...
            Object returned = this.oldConfig.getProperty(path);
            if (returned instanceof Integer) {
                return (Integer) returned;
            } else if (returned instanceof Long) {
                return (Long) returned;
            } else {
                return Long.parseLong((String)returned);
            }
        }
    }
    ...
    public Object get(String path) {
        if (this.useNew) {
            return this.newConfig.getString(path, null);
        } else {
            return this.oldConfig.getProperty(path);
        }
    }
